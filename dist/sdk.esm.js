...
var _FACTORY_ADDRESS_MAP, _INIT_CODE_HASH_MAP, _SOLIDITY_TYPE_MAXIMA, _WROSE, _WNATIVE, _NATIVE;
var ChainId;

(function (ChainId) {
  ChainId[ChainId["OASIS_MAINNET"] = 26863] = "OASIS_MAINNET";
  ChainId[ChainId["EMERALD_TESTNET"] = 42261] = "EMERALD_TESTNET";
  ChainId[ChainId["EMERALD_MAINNET"] = 42262] = "EMERALD_MAINNET";
})(ChainId || (ChainId = {}));
...
var FACTORY_ADDRESS = '0x8fA72dE7e5635188F0fbcA122C86D67Dd8429fF1';
var FACTORY_ADDRESS_MAP = (_FACTORY_ADDRESS_MAP = {}, _FACTORY_ADDRESS_MAP[ChainId.EMERALD_MAINNET] = FACTORY_ADDRESS, _FACTORY_ADDRESS_MAP[ChainId.EMERALD_TESTNET] = '0x69ef1662D9544b007D5B8FF827C86793D8F04E79', _FACTORY_ADDRESS_MAP);
var INIT_CODE_HASH = '0xadb8ced8622f5a41096bc3443794fdcb518f1f9d9aa5b5c98fa1f9bda862638b';
var INIT_CODE_HASH_MAP = (_INIT_CODE_HASH_MAP = {}, _INIT_CODE_HASH_MAP[ChainId.EMERALD_MAINNET] = INIT_CODE_HASH, _INIT_CODE_HASH_MAP[ChainId.EMERALD_TESTNET] = '0xadb8ced8622f5a41096bc3443794fdcb518f1f9d9aa5b5c98fa1f9bda862638b', _INIT_CODE_HASH_MAP);
...
var WROSE = (_WROSE = {}, _WROSE[ChainId.EMERALD_MAINNET] = /*#__PURE__*/new Token(ChainId.EMERALD_MAINNET, '0x21C718C22D52d0F3a789b752D4c2fD5908a8A733', 18, 'WROSE', 'Wrapped ROSE', 'https://rose.io'), _WROSE[ChainId.EMERALD_TESTNET] = /*#__PURE__*/new Token(ChainId.EMERALD_TESTNET, '0x966be6f726C6D600Fd199aF3E6396cC4930cFbCC', 18, 'WROSE', 'Wrapped ROSE', 'https://rose.io'), _WROSE);
var WNATIVE = (_WNATIVE = {}, _WNATIVE[ChainId.EMERALD_MAINNET] = WROSE[ChainId.EMERALD_MAINNET], _WNATIVE[ChainId.EMERALD_TESTNET] = WROSE[ChainId.EMERALD_TESTNET], _WNATIVE);
var NATIVE = (_NATIVE = {}, _NATIVE[ChainId.EMERALD_MAINNET] = {
  name: 'Oasis Network Native Token',
  symbol: 'ROSE',
  decimals: 18
}, _NATIVE[ChainId.EMERALD_TESTNET] = {
  name: 'Oasis Network Native Token',
  symbol: 'ROSE',
  decimals: 18
}, _NATIVE);
...
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].currency.chainId, Pair.getAddress(tokenAmounts[0].currency, tokenAmounts[1].currency), 18, 'RHUB-LP', 'RoseHub LPs');
...
export { BaseCurrency, ChainId, CurrencyAmount, FACTORY_ADDRESS, FACTORY_ADDRESS_MAP, FIVE, Fraction, INIT_CODE_HASH, INIT_CODE_HASH_MAP, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, MaxUint256, NATIVE, Native, NativeCurrency, ONE, Pair, Percent, Price, Rounding, Route, Router, SOLIDITY_TYPE_MAXIMA, SolidityType, TEN, THREE, TWO, Token, Trade, TradeType, WNATIVE, WROSE, ZERO, _100, _10000, _9975, computePairAddress, computePriceImpact, inputOutputComparator, tradeComparator };
